...
A Decky plugin that uses ChatGPT (GPT-4.1 Vision) to help you when you're stuck in a game. Take a screenshot and let AI analyze it to provide step-by-step guidance on how to proceed with your quest.

## Features

- 🎮 AI-powered quest assistance using GPT-4.1 Vision
